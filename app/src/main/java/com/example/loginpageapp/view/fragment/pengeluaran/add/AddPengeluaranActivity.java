package com.example.loginpageapp.view.fragment.pengeluaran.add;
...
import com.example.loginpageapp.view.MainActivity2;
...
public class AddPengeluaranActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            startActivity(new Intent(AddPengeluaranActivity.this, MainActivity2.class));
            return true;
        }
